...
class grafana (
  ...
  $ldap_cfg_root_ca_cert          = $::grafana::params::ldap_cfg_root_ca_cert,
  $ldap_cfg_bind_dn               = $::grafana::params::ldap_cfg_bind_dn,
  $ldap_cfg_bind_password         = $::grafana::params::ldap_cfg_bind_password,
  $ldap_cfg_search_filter         = $::grafana::params::ldap_cfg_search_filter,
  $ldap_cfg_search_base_dns       = $::grafana::params::ldap_cfg_search_base_dns,
  $ldap_cfg_group_search_filter   = $::grafana::params::ldap_cfg_group_search_filter,
  $ldap_cfg_group_search_base_dns = $::grafana::params::ldap_cfg_group_search_base_dns,
  $ldap_cfg_atributes_name        = $::grafana::params::ldap_cfg_atributes_name ,
  $ldap_cfg_atributes_surname     = $::grafana::params::ldap_cfg_atributes_surname,
  $ldap_cfg_atributes_username    = $::grafana::params::ldap_cfg_atributes_username ,
  $ldap_cfg_atributes_member_of   = $::grafana::params::ldap_cfg_atributes_member_of,
  $ldap_cfg_atributes_email       = $::grafana::params::ldap_cfg_atributes_email,
  $ldap_cfg_group_mappings        = $::grafana::params::ldap_cfg_group_mappings,
